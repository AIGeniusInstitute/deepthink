...
interface GroupState {
  ...
  /**
   * DeepThink user id that started the current run (idle→active), or null when
...
export class GroupQueue {
  ...
  /**
   * The DeepThink user id that started the currently-active *message* run owning
  ...
  sendMessage(
    ...
    // the task finishes.  See GitHub issue AIGeniusInstitute/deep-think#151.
    //
