...
export const ASSISTANT_NAME = process.env.ASSISTANT_NAME || 'DeepThink';
...
export const CONTAINER_IMAGE =
  process.env.CONTAINER_IMAGE || 'deepthink-agent:latest';
...
export const SESSION_COOKIE_NAME_SECURE = '__Host-deepthink_session';
export const SESSION_COOKIE_NAME_PLAIN = 'deepthink_session';
