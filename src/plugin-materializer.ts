 ...
 *      marker = runtime/{userId}/snapshots/{snapshotId}/@deepthink-runtime-markers/{mp}/{plugin}.json
 ...
 */
const MARKER_DIRNAME = '@deepthink-runtime-markers';
...
/** runtime/{userId}/snapshots/{snapshotId}/@deepthink-runtime-markers/{mp}/{plugin}.json */
