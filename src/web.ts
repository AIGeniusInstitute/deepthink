...
import mcpRegistryRoutes from './routes/mcp-registry.js';import pluginsRoutes from './routes/plugins.js';
...
import paasAdminRoutes from './routes/paas-admin.js';
...
import { staffEmployeeRoutes } from './routes/staff-employees.js';
import { staffTeamRoutes } from './routes/staff-teams.js';
import { staffDashboardRoutes } from './routes/staff-dashboard.js';
...
app.route('/api/paas/admin', paasAdminRoutes);
app.route('/api/paas/embedding-config', paasEmbeddingRoutes);
...
app.route('/api/staff/employees', staffEmployeeRoutes);
app.route('/api/staff/teams', staffTeamRoutes);
app.route('/api/staff/dashboard', staffDashboardRoutes);
...
function setupWebSocket(server: any): WebSocketServer {
  ...
  server.on('upgrade', (request: any, socket: any, head: any) => {
    ...
    request.__deepthinkSessionId = token;
  ...
  wss.on('connection', (ws, request: any) => {
    const sessionId = request?.__deepthinkSessionId as string | undefined;
