/**
 * Shared i18n language constants.
 *
 * Used by:
 * - src/schemas.ts (zod enum validation for ProfileUpdateSchema.language)
 * - src/container-runner.ts (ContainerInput.userLanguage type)
 * - container/agent-runner/src/i18n-directive.ts (buildLanguageDirective)
 *
 * Mirrored to web/src/i18n/languages.ts for frontend use.
 */
