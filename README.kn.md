...
http://localhost:3000 ತೆರೆಯಿರಿ ಮತ್ತು ಸೆಟಪ್ ವಿಜಾರ್ಡ್ ಅನುಸರಿಸಿ: admin ರಚಿಸಿ (ಯಾವುದೇ ಡಿಫಾಲ್ಟ್ ಖಾತೆ ಇಲ್ಲ), Claude API ಸಂರಚಿಸಿ ಮತ್ತು ಅಗತ್ಯವಿದ್ದರೆ IM ಚಾನಲ್‌ಗಳನ್ನು ಹೊಂದಿಸಿ. ಎಲ್ಲವೂ ವೆಬ್ ಇಂಟರ್ಫೇಸ್‌ನಿಂದ ಸಂರಚಿಸಲ್ಪಡುತ್ತದೆ, ಯಾವುದೇ ಸಂರಚನಾ ಫೈಲ್ ಬೇಡ. API ಕೀಗಳು AES-256-GCM ನಿಂದ ಎನ್‌ಕ್ರಿಪ್ಟ್ ಆಗುತ್ತವೆ.
