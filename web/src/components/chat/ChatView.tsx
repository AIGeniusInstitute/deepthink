...
import { ArrowLeft, Bell, FolderOpen, Globe, History, Link, MessageSquare, Monitor, Moon, MoreHorizontal, PanelRightClose, PanelRightOpen, Puzzle, Server, Sun, Terminal, Users, Variable, Workflow, X } from 'lucide-react';import { useDisplayMode } from '../../hooks/useDisplayMode';
...
import { TraceReplayPlayer } from './TraceReplayPlayer';
...
const SIDEBAR_TABS = [
  ...
  { id: 'replay' as const, icon: History, label: '回放' },
...
type SidebarTab = 'files' | 'env' | 'skills' | 'mcp' | 'dag' | 'replay' | 'sandbox' | 'reminder' | 'members';
        ...
        <div className={cn(
          ...
          <div className="flex-1 overflow-hidden min-h-0">
            {sidebarTab === 'files' ? (
              ...
              <TraceReplayPlayer chatJid={groupJid} />
            ) : sidebarTab === 'sandbox' ? (
