      ...
      {!groupFolder && (
        <div className="block lg:hidden w-full overflow-y-auto">
          ...
          <div className="flex items-center gap-3 px-4 pt-5 pb-3">
            <img src={`${import.meta.env.BASE_URL}icons/logo-text.svg`} alt={appearance?.appName || 'DeepThink'} className="h-8" />
          ...
          {hasAnyGroup ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 px-4">
              <img src={`${import.meta.env.BASE_URL}icons/logo-text.svg`} alt={appearance?.appName || 'DeepThink'} className="h-12 mb-6" />
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center bg-background rounded-t-3xl rounded-b-none mt-5 mr-5 mb-0 ml-3 relative">
          <div className="text-center max-w-sm">
            ...
            <div className="w-16 h-16 rounded-2xl overflow-hidden mx-auto mb-6">
              <img src={`${import.meta.env.BASE_URL}icons/icon-192.png`} alt="DeepThink" className="w-full h-full object-cover" />
            </div>
            <h2 className="text-xl font-semibold text-foreground mb-2">
              欢迎使用 {appearance?.appName || 'DeepThink'}
            </h2>
