...
- **Agent Group Chat (Swarm)** *(v1.4.0)* — Групповые беседы нескольких Agent на основе мест (seats), где каждое место привязывает определение Agent со своим role prompt, политикой высказываний, монтированиями и бюджетом токенов/времени, плюс живая панель выполнения pipeline
