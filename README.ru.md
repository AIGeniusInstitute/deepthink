...
DeepThink — это самохостинговая многопользовательская система AI Agent, построенная на [Claude Agent SDK](https://github.com/anthropics/claude-agent-sdk-typescript). Она оборачивает полный рантайм Claude Code в сервис, доступный через Feishu, Telegram, QQ, DingTalk, WeChat и веб-интерфейс, с поддержкой чтения/записи файлов, операций в терминале, автоматизации браузера, многоуровневого рассуждения и экосистемы инструментов MCP.
