...
http://localhost:3000 पर जाएँ और सेटअप विज़ार्ड का पालन करें: व्यवस्थापक बनाएँ (कोई डिफ़ॉल्ट खाता नहीं), Claude API कॉन्फ़िगर करें, और वैकल्पिक रूप से IM चैनल कॉन्फ़िगर करें। सभी कॉन्फ़िगरेशन Web इंटरफ़ेस से किया जाता है, बिना किसी कॉन्फ़िग फ़ाइल के। API कुंजी AES-256-GCM के साथ एन्क्रिप्टेड रूप से संग्रहीत होती है।
