...
- **Agent Group Chat (Swarm)** *(v1.4.0)* — Групові багато-Agent розмови на основі місць (seat), де кожне місце прив'язує визначення agent із власним рольовим промптом, політикою виступів, монтуваннями та бюджетом токенів/часу, плюс жива панель виконання pipeline
