...
- **Agent গ্রুপ চ্যাট (Swarm)** *(v1.4.0)* — সিট-ভিত্তিক মাল্টি-Agent গ্রুপ কথোপকথন, যেখানে প্রতিটি সিট একটি Agent সংজ্ঞাকে তার নিজস্ব রোল প্রম্পট, স্পিক পলিসি, মাউন্ট ও টোকেন/সময় বাজেটের সাথে বাইন্ড করে, সাথে একটি লাইভ পাইপলাইন এক্সিকিউশন প্যানেল
