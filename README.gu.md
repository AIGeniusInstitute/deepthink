...
http://localhost:3000 ખોલો અને સેટઅપ વિઝાર્ડ અનુસરો: admin બનાવો (કોઈ ડિફૉલ્ટ એકાઉન્ટ નહિ), Claude API ગોઠવો અને જરૂર પ્રમાણે IM ચેનલ. બધું જ વેબ ઇન્ટરફેસથી ગોઠવાય છે, કોઈ રૂપરેખા ફાઇલ નહિ. API કી AES-256-GCM થી એન્ક્રિપ્ટ થાય છે.
