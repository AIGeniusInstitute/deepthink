...
زر http://localhost:3000 واتبع معالج الإعداد: أنشئ المسؤول (لا يوجد حساب افتراضي)، هيّئ Claude API، واختياريًا هيّئ قنوات المراسلة. تتم كل التهيئة من واجهة Web دون أي ملفات تهيئة. تُخزَّن مفاتيح API مشفّرة بـ AES-256-GCM.
