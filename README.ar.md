...
- **محادثة جماعية للوكلاء (Swarm)** *(v1.4.0)* — محادثات جماعية متعددة الوكلاء قائمة على المقاعد، حيث يربط كل مقعد تعريف وكيل بموجّه دوره الخاص وسياسة التحدّث ونقاط التركيب وميزانية الرموز/الوقت، إلى جانب لوحة تنفيذ مباشرة لخط الأنابيب
